      ...
      <div className="container mx-auto px-4">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="relative">
            <div className="absolute left-0 top-0 bottom-0 w-px bg-auth-primary/20 ml-[5.5rem]" />
            <div className="space-y-12">
              {items.map((item, i) => (
                <div key={i} className="flex gap-8">
                  <div className="w-24 shrink-0 text-right">
                    <span className="text-xs font-mono text-auth-primary/60 tracking-wide">{item.era}</span>
                  </div>
                  <div className="relative pl-8">
                    <div className="absolute left-0 top-1.5 w-2.5 h-2.5 rounded-full bg-auth-primary ring-4 ring-auth-primary/10 -translate-x-[calc(50%+0.5px)]" />
