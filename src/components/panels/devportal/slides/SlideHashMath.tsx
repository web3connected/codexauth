...
export default function SlideHashMath({ isActive }: HeroSlideProps) {
  return (
    ...
    >
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-auth-primary/15 via-transparent to-blue-900/15 pointer-events-none" />
      ...
      <div className="relative z-10 container mx-auto px-4 pt-36 pb-28">
        ...
        {/* Left: text */}
        <div>
          <p className="text-xs font-mono text-auth-primary/60 tracking-widest uppercase mb-4">CodexHarmonicHash · Algorithm v2</p>
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight">
            <span className="whitespace-nowrap">
              <span className="text-auth-primary">Harmonic</span>
              {' '}
              <span className="text-white">Strength.</span>
            </span>
            <br />
            <span className="whitespace-nowrap text-2xl md:text-3xl lg:text-4xl">
              <span className="text-auth-primary">Mathematically</span>
              {' '}
              <span className="text-auth-accent">different.</span>
            </span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <Link
              ...
              className="group inline-flex items-center gap-2 px-7 py-4 rounded-lg bg-auth-primary text-white font-semibold transition-all hover:bg-auth-primary/90 hover:scale-105 hover:shadow-lg hover:shadow-auth-primary/25"
            >
        ...
        <div className="grid grid-cols-2 gap-4">
          {[
            ...
            <div key={i} className="p-5 rounded-2xl border border-white/10 bg-white/5 backdrop-blur-sm">
              <div className="text-2xl font-bold text-auth-primary mb-1 font-mono">{s.value}</div>
