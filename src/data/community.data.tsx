import type { CommunityLink, CommunityCtaButton } from '@/components/codex/shared/panels/CommunityLinksPanel';

export const codexHashCommunityLinks: CommunityLink[] = [
  {
    icon: (
    ...
    href: 'https://github.com/web3codex/codexauth',
    external: true,
  },
  {
    icon: (
