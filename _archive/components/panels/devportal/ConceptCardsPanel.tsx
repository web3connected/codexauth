...
const conceptCards: ConceptCard[] = [
  ...
  },
  {
    ...
    accentColor: 'hash-secondary',
  },
]

/**
 * ConceptCardsPanel - Three core concept cards explaining what makes CodexHash unique.
