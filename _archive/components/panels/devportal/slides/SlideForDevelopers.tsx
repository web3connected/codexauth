...
export default function SlideForDevelopers({ isActive }: HeroSlideProps) {
  return (
    ...
    >
      ...
      <div className="absolute inset-0 bg-gradient-to-tl from-hash-secondary/15 via-transparent to-hash-primary/10 pointer-events-none" />
      ...
      <div className="relative z-10 container mx-auto px-4 pt-36 pb-28">
        ...
        {/* Headline */}
        <div className="mb-8">
          <p className="text-xs font-mono text-hash-primary/60 tracking-widest uppercase mb-4">REST API · SDKs · Webhooks</p>
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight">
            <span className="text-white">One endpoint.</span>
            <br />
            <span className="whitespace-nowrap">
              <span className="text-hash-secondary">Production-ready</span>
              {' '}
              <span className="text-hash-primary">in minutes.</span>
            </span>
          </h1>
        </div>
        ...
        <div className="rounded-2xl border border-white/10 bg-black/60 backdrop-blur-sm overflow-hidden mb-8">
          ...
          <div className="p-6 font-mono text-sm leading-relaxed">
            ...
            <div className="mt-3">
              ...
              <span className="text-slate-300"> -X POST https://codexhash.web3connected.com/api/hash/ \</span>
            </div>
        ...
        <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-6">
          <div className="flex flex-col sm:flex-row gap-4">
            <Link
              ...
              className="group inline-flex items-center gap-2 px-7 py-3.5 rounded-lg bg-hash-primary text-white font-semibold transition-all hover:bg-hash-primary/90 hover:scale-105 hover:shadow-lg hover:shadow-hash-primary/25"
            >
              Start Building
          ...
          <div className="flex gap-8">
            {[
              ...
              <div key={i} className="text-center">
                <div className="text-2xl font-bold text-hash-primary font-mono">{s.value}</div>
