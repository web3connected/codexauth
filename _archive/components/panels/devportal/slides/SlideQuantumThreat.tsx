...
export default function SlideQuantumThreat({ isActive }: HeroSlideProps) {
  return (
    ...
    >
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-red-900/20 via-transparent to-hash-primary/10 pointer-events-none" />
      ...
      <div className="relative z-10 container mx-auto px-4 pt-36 pb-28">
        ...
        <h1 className="text-5xl md:text-7xl font-bold mb-6 leading-tight">
          ...
          <br />
          <span className="text-transparent bg-clip-text bg-gradient-to-r from-red-400 via-hash-accent to-red-800 w-fit mx-auto">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-12">
          <Link
            href="/security"
            className="group inline-flex items-center gap-2 px-8 py-4 rounded-lg bg-hash-primary text-white font-semibold transition-all hover:bg-hash-primary/90 hover:scale-105 hover:shadow-lg hover:shadow-hash-primary/25"
          >
